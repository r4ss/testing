SS_writedat3.3 <- function(datlist,outfile,overwrite=FALSE,verbose=TRUE){
  ...
  # write a header
  writeLines("#C data file created using the SS_writedat3.3 function in the R package r4ss")
  writeLines(paste("#C attempting to make a file that works with SS version:",datlist$SSversion))
